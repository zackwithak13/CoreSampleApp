        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupName = table.Column<string>(type: "Name", maxLength: 50, nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SalesReasonID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Name = table.Column<string>(type: "Name", maxLength: 50, nullable: false),
                    ReasonType = table.Column<string>(type: "Name", maxLength: 50, nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    BusinessEntityID = table.Column<int>(nullable: false),
                    AccountNumber = table.Column<string>(type: "AccountNumber", maxLength: 15, nullable: false),
                    Name = table.Column<string>(type: "Name", maxLength: 50, nullable: false),
                    CreditRating = table.Column<byte>(nullable: false),
                    PreferredVendorStatus = table.Column<bool>(type: "Flag", nullable: false, defaultValueSql: "((1))"),
                    ActiveFlag = table.Column<bool>(type: "Flag", nullable: false, defaultValueSql: "((1))"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SalariedFlag = table.Column<bool>(type: "Flag", nullable: false, defaultValueSql: "((1))"),
                    VacationHours = table.Column<short>(nullable: false),
                    SickLeaveHours = table.Column<short>(nullable: false),
                    CurrentFlag = table.Column<bool>(type: "Flag", nullable: false, defaultValueSql: "((1))"),
                    rowguid = table.Column<Guid>(nullable: false, defaultValueSql: "(newid())"),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    BusinessEntityID = table.Column<int>(nullable: false),
                    PhoneNumber = table.Column<string>(type: "Phone", maxLength: 25, nullable: false),
                    PhoneNumberTypeID = table.Column<int>(nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountryRegionCode = table.Column<string>(maxLength: 3, nullable: false),
                    IsOnlyStateProvinceFlag = table.Column<bool>(type: "Flag", nullable: false, defaultValueSql: "((1))"),
                    Name = table.Column<string>(type: "Name", maxLength: 50, nullable: false),
                    TerritoryID = table.Column<int>(nullable: false),
                    rowguid = table.Column<Guid>(nullable: false, defaultValueSql: "(newid())"),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())")
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MakeFlag = table.Column<bool>(type: "Flag", nullable: false, defaultValueSql: "((1))"),
                    FinishedGoodsFlag = table.Column<bool>(type: "Flag", nullable: false, defaultValueSql: "((1))"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductReviewID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ProductID = table.Column<int>(nullable: false),
                    ReviewerName = table.Column<string>(type: "Name", maxLength: 50, nullable: false),
